...
try:
    ...
    def _ts():
        return datetime.datetime.now(pytz.timezone("Asia/Kolkata")).strftime("%d-%m-%Y %H:%M:%S IST")
    def _date_str():
        return datetime.datetime.now(pytz.timezone("Asia/Kolkata")).strftime("%d-%m-%Y")
