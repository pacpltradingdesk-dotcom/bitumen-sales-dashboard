...
class DirectorBriefingEngine:
    ...
    def generate_briefing(self, target_date=None) -> dict:
        ...
        briefing = {
            "greeting": greeting,
            "timestamp": now.strftime("%d-%m-%Y %H:%M IST"),
            "generated_at": now.strftime("%d-%m-%Y %H:%M IST"),
    ...
    def get_yesterday_summary(self, reference_date: str = None) -> dict:
        ...
        try:
            ...
            yesterday_str = (datetime.datetime.now(IST) - datetime.timedelta(days=1)).strftime("%d-%m-%Y")
            for c in comm_log:
    ...
    def _get_outlook(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "generated_at": datetime.datetime.now(IST).strftime("%d-%m-%Y %H:%M IST"),
            }
