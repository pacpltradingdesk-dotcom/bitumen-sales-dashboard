...
MODULE_NAV: dict[str, dict] = {
    ...
    "🚚 Logistics": {
        ...
        "tabs": [
            ...
            {"label": "Port Ops",            "page": "⚓ Port Import Tracker"},
    ...
    "🧠 Intelligence": {
        ...
        "tabs": [
            {"label": "Market Dashboard",   "page": "🔍 Opportunities",
             "also": ["📈 Demand Correlation", "🕵️ Competitor Intelligence"]},
